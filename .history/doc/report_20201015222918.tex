...
\section{Method}\label{sec:meth}
    ...
    identifying the optimal parameters to identify the most optimal filter, and the best result was returned for the user \ref{Fig:flowchart}.

    I want this picture to appear.
    \begin{figure}[h!]
        \centering
        \graphicspath{{./wiki/}}
