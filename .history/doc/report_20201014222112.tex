...
\section{Background}\label{sec:bg}
    \subsection{Digital Signal Processing of ECG Signals}\label{sec:bg_sub1}
        ...
        as shown in \ref{Fig:fig1}. It should be noted that the first peak in \ref{Fig:fig1} is the 
        DC component due to the use FFT to get the frequency response of the time domain E.
