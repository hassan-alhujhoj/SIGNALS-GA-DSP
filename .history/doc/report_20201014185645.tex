...
\section{Method}\label{sec:meth}
    ...
    \subsection{Creating a Population from DSP Singal Data}\label{sec:bg_sub1}
    \subsection{Fitness Function}\label{sec:bg_sub1}
    \subsection{Selecting Paranets for next GA Generations}\label{sec:bg_sub1}
    \subsection{GA Operators}\label{sec:bg_sub1}
        \subsubsection{Crossover}
        \subsubsection{Mutation}
        \subsubsection{Parents}
    \subsection{Filtering of ECG Signal Using FIR Filters}\label{sec:bg_sub1}
