...
\section{Method}\label{sec:meth}
    ...
    \subsection{Fitness Function}\label{sec:meth_sub1}
    \subsection{Selecting Paranets for next GA Generations}\label{sec:meth_sub1}
    \subsection{GA Operators}\label{sec:meth_sub1}
        \subsubsection{Crossover}
        \subsubsection{Mutation}
        \subsubsection{Parents}
    \subsection{Filtering of ECG Signal Using FIR Filters}\label{sec:meth_sub1}
