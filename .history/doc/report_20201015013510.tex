...
\section{Introduction}\label{sec:intro}
    ...
    the one-point crossover mechanism is shown in Figure \ref{Fig:fig1}. Genes are exchanged between parents to form offspring. Mutations are randomly generated after crossover with a small probability of occurrence.
...
\section{Background}\label{sec:bg}
    \subsection{Digital Signal Processing of ECG Signals}\label{sec:bg_sub1}
        ...
        \begin{figure}[h!]
            \centering
            \graphicspath{{./wiki/}}
            \includegraphics[scale=0.4]{bf_filtering_10kGen.png}
            \caption{Interference frequencies present in the ECG signal.}
            \label{Fig:rejFreq}
        \end{figure}
