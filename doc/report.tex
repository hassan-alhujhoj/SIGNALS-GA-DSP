...
\section{Results}\label{sec:res}
    ...
    quick calculation time \cite[]{Garip2018} .
...
\section{Discussion}\label{sec:dis}
    ...
    high degrees of accuracy. However, the algorithm took a reasonable time to produce results. This may not be practical in
    other applications. 
    \\\\
    ...
    and manually designing a filter to complete this problem. Other iteration techniques could also be used to solve for the 
...
\section{Conclusion}\label{sec:conc}
    ...
    \\\\
    Genetic Algorithms were applied to a ECG data signal to filter interference from the graph. 
