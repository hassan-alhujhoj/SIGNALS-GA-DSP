...
\section{Method}\label{sec:meth}
    ...
    \begin{figure}[h!]
        ...
        \caption{Flowchart diagram of GA of ECG signals.}
        \label{Fig:flowchart}
    \end{figure}
...
\section{Results}\label{sec:res}
    ...
    maximum SNR. With the filter population size of $p_size = 20$, and a maximum number of iterations of $n = 1000$, a filtered 
    ...
    parameters. This proved the fitness function was robust, successfully identifying frequencies without needing specific tuning. 
    \begin{figure}[h!]
        \centering
        \graphicspath{{./wiki/}}
    ...
    \end{figure}
    \\\\
    When contrasting number of iterations with the population frequency, it was found the maximum fitness consistently reached 
    the maximum population fitness within 50 iterations. However, when the population size was decreased, a larger number of
    iterations was required to reach the optimum fitness. Using $p_size = 20$, $n = 50$ gave reasonable filter results with a
    ...
    \begin{figure}[h!]
        ...
        \caption{The population fitness of ECG signal 1 through iterations, using $p_size = 20$, $n = 1000$.}
        \label{Fig:result_2}
    \end{figure}

\section{Discussion}\label{sec:dis}
    The Genetic Algorithm has been effective at identifying and filtering the interference frequencies from the data.
