...
cal_pop_fitness:    Calculating the population fitness for Digital Signal Processing
                    The Signal to Noise Ratio was used as the fitness function, with higher signal to noise ratios giving better results
"""
...
def crossover(parents, offspring_size):
    ...
    for k in range(offspring_size[0])fjldjf
